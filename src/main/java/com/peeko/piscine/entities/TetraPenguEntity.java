...
public class TetraPenguEntity extends CodEntity {

    //public static final Ingredient TEMPTATION_ITEMS = Ingredient.fromItems(ModItems.FISH_FOOD.get());


    public TetraPenguEntity(EntityType<? extends CodEntity> p_i50279_1_, World p_i50279_2_) {
    ...
    public static AttributeModifierMap.MutableAttribute setCustomAttributes() {
        return CodEntity.func_233666_p_()
                .createMutableAttribute(Attributes.MAX_HEALTH, 3.5d)
